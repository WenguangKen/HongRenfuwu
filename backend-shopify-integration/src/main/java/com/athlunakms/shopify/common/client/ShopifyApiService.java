...
public class ShopifyApiService {
    ...
    public ShopInfoDto getShopInfo(String storeUrl, String accessToken) {
        ...
        String apiUrl = String.format("https://%s/admin/api/%s/shop.json", normalizedUrl, SHOPIFY_API_VERSION);
        ...
        try {
            Map shopData;
            Map body;
            log.info("\u9a8c\u8bc1 Shopify \u5e97\u94fa\u8fde\u63a5: {}", (Object)normalizedUrl);
            ...
            if (response.getStatusCode() == HttpStatus.OK && (body = (Map)response.getBody()) != null && (shopData = (Map)body.get("shop")) != null) {
                log.info("Shopify \u5e97\u94fa\u9a8c\u8bc1\u6210\u529f: {}", shopData.get("name"));
                return this.mapToShopInfo(shopData);
            }
            throw new ShopifyApiException("\u65e0\u6548\u7684\u54cd\u5e94\u683c\u5f0f", "INVALID_RESPONSE");
        }
        catch (HttpClientErrorException.Unauthorized e) {
            log.warn("Shopify \u8ba4\u8bc1\u5931\u8d25: {}", (Object)normalizedUrl);
            throw new ShopifyApiException("Access Token \u65e0\u6548\u6216\u5df2\u8fc7\u671f", "UNAUTHORIZED", 400);
        }
        catch (HttpClientErrorException.NotFound e) {
            log.warn("Shopify \u5e97\u94fa\u4e0d\u5b58\u5728: {}", (Object)normalizedUrl);
            throw new ShopifyApiException("\u5e97\u94fa\u4e0d\u5b58\u5728\u6216URL\u683c\u5f0f\u9519\u8bef", "NOT_FOUND", 404);
        }
        catch (HttpClientErrorException.Forbidden e) {
            log.warn("Shopify \u6743\u9650\u4e0d\u8db3: {}", (Object)normalizedUrl);
            throw new ShopifyApiException("Access Token \u6743\u9650\u4e0d\u8db3", "FORBIDDEN", 400);
        }
        catch (HttpClientErrorException e) {
            log.error("Shopify API \u5ba2\u6237\u7aef\u9519\u8bef: {} - {}", (Object)e.getStatusCode(), (Object)e.getMessage());
            int status = e.getStatusCode().value();
            if (status == 401 || status == 403) {
                status = 400;
            }
            throw new ShopifyApiException("Shopify API \u9519\u8bef: " + e.getMessage(), "API_ERROR", status);
        }
        catch (HttpServerErrorException e) {
            log.error("Shopify \u670d\u52a1\u5668\u9519\u8bef: {}", (Object)e.getMessage());
            throw new ShopifyApiException("Shopify \u670d\u52a1\u6682\u65f6\u4e0d\u53ef\u7528", "SERVER_ERROR", 503);
        }
        catch (ResourceAccessException e) {
            log.error("\u65e0\u6cd5\u8fde\u63a5\u5230 Shopify: {}", (Object)e.getMessage());
            throw new ShopifyApiException("\u65e0\u6cd5\u8fde\u63a5\u5230 Shopify \u670d\u52a1\u5668\uff0c\u8bf7\u68c0\u67e5\u7f51\u7edc", "CONNECTION_ERROR", e);
        }
        catch (ShopifyApiException e) {
            throw e;
        }
        catch (Exception e) {
            log.error("\u9a8c\u8bc1 Shopify \u5e97\u94fa\u65f6\u53d1\u751f\u672a\u77e5\u9519\u8bef: {}", e.getMessage(), e);
            throw new ShopifyApiException("\u9a8c\u8bc1\u5931\u8d25: " + e.getMessage(), "UNKNOWN_ERROR", e);
        }
    }
    ...
    private String normalizeStoreUrl(String storeUrl) {
        ...
        if (!url.contains(".myshopify.com") && !url.contains(".")) {
    ...
    public ShopifyApiService(RestTemplate restTemplate) {
