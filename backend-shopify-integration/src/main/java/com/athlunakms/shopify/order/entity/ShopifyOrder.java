...
public class ShopifyOrder {
    ...
    @Column(name="shopify_order_id", nullable=false, unique=true, length=100)
    ...
    @Column(name="shopify_customer_id", length=100)
