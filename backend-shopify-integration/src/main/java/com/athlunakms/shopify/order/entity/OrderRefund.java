...
public class OrderRefund {
    ...
    @Column(name="shopify_refund_id", nullable=false, unique=true, length=100)
    ...
    public String getShopifyRefundId() {
    ...
    public void setShopifyRefundId(String shopifyRefundId) {
    ...
    public boolean equals(Object o) {
        ...
        String this$shopifyRefundId = this.getShopifyRefundId();
        String other$shopifyRefundId = other.getShopifyRefundId();
        if (this$shopifyRefundId == null ? other$shopifyRefundId != null : !this$shopifyRefundId.equals(other$shopifyRefundId)) {
            return false;
        }
    ...
    public int hashCode() {
        ...
        String $shopifyRefundId = this.getShopifyRefundId();
        result = result * 59 + ($shopifyRefundId == null ? 43 : $shopifyRefundId.hashCode());
    ...
    public String toString() {
        return "OrderRefund(id=" + this.getId() + ", orderId=" + this.getOrderId() + ", shopifyRefundId=" + this.getShopifyRefundId() + ", createdAtShopify=" + this.getCreatedAtShopify() + ", processedAt=" + this.getProcessedAt() + ", currency=" + this.getCurrency() + ", totalRefunded=" + this.getTotalRefunded() + ", presentmentCurrency=" + this.getPresentmentCurrency() + ", presentmentTotalRefunded=" + this.getPresentmentTotalRefunded() + ", note=" + this.getNote() + ", restock=" + this.getRestock() + ", syncAt=" + this.getSyncAt() + ")";
    }
}
