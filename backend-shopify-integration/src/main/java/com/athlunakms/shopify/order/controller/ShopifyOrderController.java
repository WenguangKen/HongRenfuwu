...
import com.athlunakms.shopify.order.dto.ShopifyOrderDto;
...
public class ShopifyOrderController {
    private static final Logger log = LoggerFactory.getLogger(ShopifyOrderController.class);
     ...
     */
    @GetMapping
    public ApiResponse<List<ShopifyOrderDto>> getAllOrders(@RequestParam(value="storeId", required=false) Long storeId) {
        List<ShopifyOrderDto> orders = storeId != null ? this.orderService.getOrdersByStoreId(storeId) : this.orderService.getAllOrders();
