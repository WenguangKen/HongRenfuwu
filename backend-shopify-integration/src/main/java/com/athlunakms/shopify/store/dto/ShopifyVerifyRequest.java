...
public class ShopifyVerifyRequest {
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof ShopifyVerifyRequest)) {
            return false;
        }
        ShopifyVerifyRequest other = (ShopifyVerifyRequest)o;
    ...
    protected boolean canEqual(Object other) {
        return other instanceof ShopifyVerifyRequest;
    }
    ...
    public String toString() {
        return "ShopifyVerifyRequest(storeUrl=" + this.getStoreUrl() + ", accessToken=" + this.getAccessToken() + ")";
    }
}
