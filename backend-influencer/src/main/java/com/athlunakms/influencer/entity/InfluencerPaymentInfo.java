...
@Entity
@Table(name="influencer_payment_info", indexes={@Index(name="idx_paymentinfo_influencer", columnList="influencer_id", unique=true)})
public class InfluencerPaymentInfo {
    @Id
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof InfluencerPaymentInfo)) {
            return false;
        }
        InfluencerPaymentInfo other = (InfluencerPaymentInfo)o;
    ...
    protected boolean canEqual(Object other) {
        return other instanceof InfluencerPaymentInfo;
    }
