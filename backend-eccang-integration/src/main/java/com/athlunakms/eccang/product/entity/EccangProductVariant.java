...
public class EccangProductVariant {
    ...
    @Column(name="eccang_variant_id", nullable=false, unique=true)
    ...
    public Integer getFbaInventory() {
    ...
    public void setFbaInventory(Integer fbaInventory) {
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof EccangProductVariant)) {
            return false;
        }
        EccangProductVariant other = (EccangProductVariant)o;
    ...
    protected boolean canEqual(Object other) {
        return other instanceof EccangProductVariant;
    }
    ...
    public String toString() {
        return "EccangProductVariant(id=" + this.getId() + ", productId=" + this.getProductId() + ", eccangVariantId=" + this.getEccangVariantId() + ", eccangProductId=" + this.getEccangProductId() + ", onlineStoreUrl=" + this.getOnlineStoreUrl() + ", title=" + this.getTitle() + ", sku=" + this.getSku() + ", barcode=" + this.getBarcode() + ", price=" + this.getPrice() + ", compareAtPrice=" + this.getCompareAtPrice() + ", inventoryQuantity=" + this.getInventoryQuantity() + ", option1=" + this.getOption1() + ", option2=" + this.getOption2() + ", option3=" + this.getOption3() + ", imageUrl=" + this.getImageUrl() + ", weight=" + this.getWeight() + ", weightUnit=" + this.getWeightUnit() + ", position=" + this.getPosition() + ", createdAt=" + this.getCreatedAt() + ", updatedAt=" + this.getUpdatedAt() + ")";
    }
}
