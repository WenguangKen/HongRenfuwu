...
public class EccangProduct {
    ...
    private Long id;
    @Column(name="eccang_product_id", nullable=false, unique=true)
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof EccangProduct)) {
            return false;
        }
        EccangProduct other = (EccangProduct)o;
    ...
    protected boolean canEqual(Object other) {
        return other instanceof EccangProduct;
    }
