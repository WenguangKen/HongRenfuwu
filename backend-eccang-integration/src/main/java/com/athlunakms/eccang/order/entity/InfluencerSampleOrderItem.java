...
@Entity
@Table(name="influencer_sample_order_item")
public class InfluencerSampleOrderItem {
    @Id
    @GeneratedValue(strategy=GenerationType.IDENTITY)
    private Long id;
    @Column(name="sample_order_id", nullable=false)
    private Long sampleOrderId;
    @Column(name="eccang_line_item_id")
    private String eccangLineItemId;
    @Column(name="eccang_product_id")
    private Long eccangProductId;
    @Column(name="eccang_variant_id")
    ...
    public Long getSampleOrderId() {
        return this.sampleOrderId;
    }

    public String getEccangLineItemId() {
        return this.eccangLineItemId;
    }

    public Long getEccangProductId() {
        return this.eccangProductId;
    }

    public Long getEccangVariantId() {
        return this.eccangVariantId;
    }
    ...
    public void setSampleOrderId(Long sampleOrderId) {
        this.sampleOrderId = sampleOrderId;
    }

    public void setEccangLineItemId(String eccangLineItemId) {
        this.eccangLineItemId = eccangLineItemId;
    }

    public void setEccangProductId(Long eccangProductId) {
        this.eccangProductId = eccangProductId;
    }

    public void setEccangVariantId(Long eccangVariantId) {
        this.eccangVariantId = eccangVariantId;
    }
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof InfluencerSampleOrderItem)) {
            return false;
        }
        InfluencerSampleOrderItem other = (InfluencerSampleOrderItem)o;
        ...
        Long this$sampleOrderId = this.getSampleOrderId();
        Long other$sampleOrderId = other.getSampleOrderId();
        if (this$sampleOrderId == null ? other$sampleOrderId != null : !((Object)this$sampleOrderId).equals(other$sampleOrderId)) {
            return false;
        }
        Long this$eccangProductId = this.getEccangProductId();
        Long other$eccangProductId = other.getEccangProductId();
        if (this$eccangProductId == null ? other$eccangProductId != null : !((Object)this$eccangProductId).equals(other$eccangProductId)) {
            return false;
        }
        Long this$eccangVariantId = this.getEccangVariantId();
        Long other$eccangVariantId = other.getEccangVariantId();
        if (this$eccangVariantId == null ? other$eccangVariantId != null : !((Object)this$eccangVariantId).equals(other$eccangVariantId)) {
            return false;
        }
        ...
        String this$eccangLineItemId = this.getEccangLineItemId();
        String other$eccangLineItemId = other.getEccangLineItemId();
        if (this$eccangLineItemId == null ? other$eccangLineItemId != null : !this$eccangLineItemId.equals(other$eccangLineItemId)) {
            return false;
        }
    ...
    protected boolean canEqual(Object other) {
        return other instanceof InfluencerSampleOrderItem;
    }
    ...
    public int hashCode() {
        ...
        Long $sampleOrderId = this.getSampleOrderId();
        result = result * 59 + ($sampleOrderId == null ? 43 : ((Object)$sampleOrderId).hashCode());
        Long $eccangProductId = this.getEccangProductId();
        result = result * 59 + ($eccangProductId == null ? 43 : ((Object)$eccangProductId).hashCode());
        Long $eccangVariantId = this.getEccangVariantId();
        result = result * 59 + ($eccangVariantId == null ? 43 : ((Object)$eccangVariantId).hashCode());
        ...
        String $eccangLineItemId = this.getEccangLineItemId();
        result = result * 59 + ($eccangLineItemId == null ? 43 : $eccangLineItemId.hashCode());
    ...
    public String toString() {
        return "InfluencerSampleOrderItem(id=" + this.getId() + ", sampleOrderId=" + this.getSampleOrderId() + ", eccangLineItemId=" + this.getEccangLineItemId() + ", eccangProductId=" + this.getEccangProductId() + ", eccangVariantId=" + this.getEccangVariantId() + ", sku=" + this.getSku() + ", title=" + this.getTitle() + ", variantTitle=" + this.getVariantTitle() + ", quantity=" + this.getQuantity() + ", price=" + this.getPrice() + ", imageUrl=" + this.getImageUrl() + ", fulfillmentStatus=" + this.getFulfillmentStatus() + ", fulfillmentId=" + this.getFulfillmentId() + ", returnedQuantity=" + this.getReturnedQuantity() + ", vendor=" + this.getVendor() + ", total=" + this.getTotal() + ", totalDiscount=" + this.getTotalDiscount() + ", requiresShipping=" + this.getRequiresShipping() + ", giftCard=" + this.getGiftCard() + ", fulfillableQuantity=" + this.getFulfillableQuantity() + ", isReturned=" + this.getIsReturned() + ", createdAt=" + this.getCreatedAt() + ")";
    }
}
