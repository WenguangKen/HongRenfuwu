...
public class OrderTransaction {
    ...
    @Column(name="eccang_transaction_id", nullable=false, unique=true, length=100)
    private String eccangTransactionId;
    ...
    public String getEccangTransactionId() {
        return this.eccangTransactionId;
    }
    ...
    public void setEccangTransactionId(String eccangTransactionId) {
        this.eccangTransactionId = eccangTransactionId;
    }
    ...
    public boolean equals(Object o) {
        ...
        String this$eccangTransactionId = this.getEccangTransactionId();
        String other$eccangTransactionId = other.getEccangTransactionId();
        if (this$eccangTransactionId == null ? other$eccangTransactionId != null : !this$eccangTransactionId.equals(other$eccangTransactionId)) {
            return false;
        }
    ...
    public int hashCode() {
        ...
        String $eccangTransactionId = this.getEccangTransactionId();
        result = result * 59 + ($eccangTransactionId == null ? 43 : $eccangTransactionId.hashCode());
    ...
    public String toString() {
        return "OrderTransaction(id=" + this.getId() + ", orderId=" + this.getOrderId() + ", eccangTransactionId=" + this.getEccangTransactionId() + ", parentTransactionId=" + this.getParentTransactionId() + ", createdAtEccang=" + this.getCreatedAtEccang() + ", kind=" + this.getKind() + ", status=" + this.getStatus() + ", gateway=" + this.getGateway() + ", amount=" + this.getAmount() + ", currency=" + this.getCurrency() + ", authorizationCode=" + this.getAuthorizationCode() + ", paymentId=" + this.getPaymentId() + ", receiptJson=" + this.getReceiptJson() + ", errorCode=" + this.getErrorCode() + ", message=" + this.getMessage() + ", syncAt=" + this.getSyncAt() + ")";
    }
}
