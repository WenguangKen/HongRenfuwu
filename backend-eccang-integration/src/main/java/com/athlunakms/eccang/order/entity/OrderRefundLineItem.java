...
public class OrderRefundLineItem {
    ...
    @Column(name="eccang_refund_line_id", length=100)
    private String eccangRefundLineId;
    @Column(name="eccang_order_line_item_id", length=100)
    private String eccangOrderLineItemId;
    ...
    public String getEccangRefundLineId() {
        return this.eccangRefundLineId;
    }

    public String getEccangOrderLineItemId() {
        return this.eccangOrderLineItemId;
    }
    ...
    public void setEccangRefundLineId(String eccangRefundLineId) {
        this.eccangRefundLineId = eccangRefundLineId;
    }

    public void setEccangOrderLineItemId(String eccangOrderLineItemId) {
        this.eccangOrderLineItemId = eccangOrderLineItemId;
    }
    ...
    public boolean equals(Object o) {
        ...
        String this$eccangRefundLineId = this.getEccangRefundLineId();
        String other$eccangRefundLineId = other.getEccangRefundLineId();
        if (this$eccangRefundLineId == null ? other$eccangRefundLineId != null : !this$eccangRefundLineId.equals(other$eccangRefundLineId)) {
            return false;
        }
        String this$eccangOrderLineItemId = this.getEccangOrderLineItemId();
        String other$eccangOrderLineItemId = other.getEccangOrderLineItemId();
        if (this$eccangOrderLineItemId == null ? other$eccangOrderLineItemId != null : !this$eccangOrderLineItemId.equals(other$eccangOrderLineItemId)) {
            return false;
        }
    ...
    public int hashCode() {
        ...
        String $eccangRefundLineId = this.getEccangRefundLineId();
        result = result * 59 + ($eccangRefundLineId == null ? 43 : $eccangRefundLineId.hashCode());
        String $eccangOrderLineItemId = this.getEccangOrderLineItemId();
        result = result * 59 + ($eccangOrderLineItemId == null ? 43 : $eccangOrderLineItemId.hashCode());
    ...
    public String toString() {
        return "OrderRefundLineItem(id=" + this.getId() + ", refundId=" + this.getRefundId() + ", orderLineItemId=" + this.getOrderLineItemId() + ", eccangRefundLineId=" + this.getEccangRefundLineId() + ", eccangOrderLineItemId=" + this.getEccangOrderLineItemId() + ", quantity=" + this.getQuantity() + ", subtotal=" + this.getSubtotal() + ", taxAmount=" + this.getTaxAmount() + ", currency=" + this.getCurrency() + ", presentmentSubtotal=" + this.getPresentmentSubtotal() + ", presentmentTaxAmount=" + this.getPresentmentTaxAmount() + ", presentmentCurrency=" + this.getPresentmentCurrency() + ", syncAt=" + this.getSyncAt() + ")";
    }
}
