...
public class OrderTransactionDto {
    ...
    public String toString() {
        return "OrderTransactionDto(id=" + this.getId() + ", orderId=" + this.getOrderId() + ", eccangTransactionId=" + this.getEccangTransactionId() + ", createdAtEccang=" + this.getCreatedAtEccang() + ", kind=" + this.getKind() + ", status=" + this.getStatus() + ", gateway=" + this.getGateway() + ", amount=" + this.getAmount() + ", currency=" + this.getCurrency() + ", authorizationCode=" + this.getAuthorizationCode() + ", errorCode=" + this.getErrorCode() + ", message=" + this.getMessage() + ", kindDisplay=" + this.getKindDisplay() + ", statusDisplay=" + this.getStatusDisplay() + ")";
    }
}
