...
public class SystemTagDto {
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof SystemTagDto)) {
            return false;
        }
        SystemTagDto other = (SystemTagDto)o;
    ...
    protected boolean canEqual(Object other) {
        return other instanceof SystemTagDto;
    }
    ...
    public String toString() {
        return "SystemTagDto(id=" + this.getId() + ", category=" + this.getCategory() + ", name=" + this.getName() + ", description=" + this.getDescription() + ", backgroundColor=" + this.getBackgroundColor() + ", borderColor=" + this.getBorderColor() + ", textColor=" + this.getTextColor() + ", sortOrder=" + this.getSortOrder() + ", enabled=" + this.getEnabled() + ", createdBy=" + this.getCreatedBy() + ", createdAt=" + this.getCreatedAt() + ", updatedAt=" + this.getUpdatedAt() + ", count=" + this.getCount() + ")";
    }
}
